...
$resultssCheck=mysqli_num_rows($resultss);
 if($resultssCheck>0){
  ...
  <meta charset="UTF-8">
     ...
     <link rel="stylesheet" href="signupUser.css">
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
  ...
  <?php
    ...
    if(isset($_GET['name'])){
        $name = $_GET['name'];
        echo '<input type="text"  name="name"  placeholder="Name" value="'.$name.'"><br><br>';
     } else{
   ...
   if(isset($_GET['address'])){
       ...
       echo '<input type="text"  name="address"  placeholder="Residential Address" value="'.$address.'"><br><br>';
    } else{
      echo '<input type="text"  name="address"  placeholder="Residential Address"><br><br>';
    }
    echo '</div>';
    ...
    echo '</div>';   
     ...
     echo '<label>Essentials needed:</label>';
    if(isset($_GET['add'])){
      $add = $_GET['add'];
