...
?>
  ...
  <meta charset="UTF-8">
     ...
     <link rel="stylesheet" href="signupRet.css">
</head>
  ...
  <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    echo'<div class="nav-link-wrapper active-nav-link">';
    echo'<a href="test5.php">Retailer</a>';
    echo'</div>';
    echo'<div class="nav-link-wrapper">';
    echo'<a href="test9.php">User</a>';
    echo'</div>';
    echo'<div class="nav-link-wrapper">';
    echo'<a href="test6.php">Volunteer</a>';
    echo'</div>';
    echo'</div><br><br>';
...
if(isset($_GET['name'])){
   $Shopname = $_GET['name'];
   echo '<input type="text"  name="name"  placeholder="Name of production/distribution site" value="'.$Shopname.'"><br><br>';
} else{
  echo '<input type="text"  name="name"  placeholder="Name of production/distribution site"><br><br>';
}
echo "</div>";
...
if(isset($_GET['item'])){
   $dealsIn = $_GET['item'];
   echo '<input type="text"  name="item"  placeholder="Items you deal in" value="'.$dealsIn.'"><br><br>';
}else{
  echo '<input type="text"  name="item"  placeholder="Items you deal in"><br><br>';
}
echo "</div>";

echo "<div class='textbox'>";
if(isset($_GET['address'])){
  $Shopaddress = $_GET['address'];
  echo '<input type="text"  name="address"  placeholder="Address of Site" value="'.$Shopaddress.'"><br><br>';
}else{
echo '<input type="text"  name="address"  placeholder="Address of Site"><br><br>';
}
echo "</div>";
...
//    echo '<input type="text"  name="register"  placeholder="Dealer" value="'.$dealer.'"><br><br>';
// }else{
//   echo '<input type="text"  name="register"  placeholder="Dealer"><br><br>';
// }
...
echo '<label>Stock details:</label>';
if(isset($_GET['stock'])){
 $stock = $_GET['stock'];
//  echo '<input type="text"  name="stock" value="'.$stock.'"><br><br>';
// }else{
// echo '<input type="text"  name="stock"><br><br>';
// }
echo '<textarea rows="6" cols="80" name="stock" value="'.$stock.'"></textarea><br><br>';
}else{
echo '<textarea rows="6" cols="80" name="stock"></textarea><br><br>';
}
echo '</div>';
...
//    }
   ...
   elseif (strpos($fullUrl, "form=invalid_factory_name") == true){
    echo "invalid characters in Sitename!";
    exit();
   }
   echo '</div>';
