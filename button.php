          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="images/sign1.jpg" class="img-responsive" alt="">
                    </div>
...
<?php
        if(isset($_POST['submit'])){
         ...
         $item = mysqli_real_escape_string($db,$_POST['product']);
         
           if($state!='NONE' && $item!='NONE') {
                 $sql = ("SELECT * FROM users where user_state = '$state'AND user_item = '$item';");
                 $results = mysqli_query($db,$sql);
                 $resultsCheck = mysqli_num_rows($results);
     
                 if($resultsCheck>0){
                    echo "<font color=green  size='6pt'><b>Producers in $state:</b>  <br><br></font>";
                     
                     while($row = mysqli_fetch_assoc($results)){
                         echo "<font size='3pt'><b>Firm Name:</b>  </font>";
                         echo $row['factories'] . "<br>";
                         echo "<font size='3pt'><b> Firm Address:</b>  </font>" ;
                         ...
                         echo "<font size='3pt'><b>Product available:</b>  </font>";
                         echo $row['user_item'] . "<br>";
                         echo "<font size='3pt'><b>Position:</b>  </font>";
                         echo $row['user_service'] . "<br>";
                         echo "<font size='3pt'><b>Stock available:</b>  </font>";
                         echo $row['user_stock'] . "<br>";
                         echo "<br><br><br>";
                      
                     } 
                     if($item == "Mask"){
                         echo  '<iframe src="https://www.google.com/maps/d/u/0/embed?mid=1-dAn3klqr1ns2qToHSUlda0mJJowC5wd" width="640" height="480"></iframe>';
                     }
                     elseif($item == "Medical Kit"){
                         echo  '<iframe src="https://www.google.com/maps/d/embed?mid=1FWusmTfcHe2aVS0gZ7KTi0Li5DtER_4p" width="640" height="480"></iframe>';
                     }
                     elseif($item == "Groceries"){
                         echo  '<iframe src="https://www.google.com/maps/d/embed?mid=1xzNExqZUT8Hxd-5Dvgrfpf6xRk4Slzki" width="640" height="480"></iframe>';
                     }
